...
def zircon():
    filepath = bbsengine.buildfilepath(QUESTDIR, "zircon-intro.txt")
    ...
    if ttyio.inputboolean("complete zircon? [Yn]: ", "Y") is False:
        ...
        bbsengine.filedisplay(args, bbsengine.buildfilepath(QUESTDIR, "zircon-fail.txt"))
